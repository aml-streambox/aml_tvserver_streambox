...
enum tvin_sig_fmt_e {
	...
	TVIN_SIG_FMT_HDMI_1600X900_60HZ = 0x447,/* upper set TVIN_SIG_FMT_HDMI_HDR */
	...
	TVIN_SIG_FMT_HDMI_7680X4320 = 0x461,
	TVIN_SIG_FMT_HDMI_3840X4320 = 0x462,
