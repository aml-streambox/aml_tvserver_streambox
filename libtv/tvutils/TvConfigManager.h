...
//[TV] section
extern int ConfigSetStr(const char *section, const char *key, const char *value);
extern const char *ConfigGetStr(const char *section, const char *key, const char *def_value);
extern int ConfigGetInt(const char *section, const char *key, const int def_value);
extern int ConfigSetInt(const char *section, const char *key, const int value);
extern float ConfigGetFloat(const char *section, const char *key, const float def_value);
extern int ConfigSetFloat(const char *section, const char *key, const int value);
